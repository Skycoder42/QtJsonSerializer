...
protected:
	...
	QJsonObject serializeMap(int mapType, const QVariantMap &value) const; //TODO make virtual
	...
	QVariantMap deserializeMap(int mapType, const QJsonObject &object, QObject *parent) const; //TODO make virtual
