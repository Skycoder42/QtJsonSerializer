...
#include <QtJsonSerializer/private/stdchronodurationconverter_p.h>
...
private:
	StdChronoDurationConverter _converter;
};
...
{
	QTest::newRow("chrono::duration") << static_cast<int>(TypeConverter::Standard);
}
...
void ChronoDurationConverterTest::addCommonSerData()
{
	QTest::newRow("nanoseconds") << QVariantHash{}
								 ...
								 << QCborValue{static_cast<QCborTag>(CborSerializer::ChronoNanoSeconds), 10}
								 << QJsonValue{10};
	QTest::newRow("nanoseconds") << QVariantHash{}
								 << TestQ {}
								 << static_cast<QObject*>(this)
	...
	QTest::newRow("microseconds") << QVariantHash{}
								  ...
								  << QCborValue{static_cast<QCborTag>(CborSerializer::ChronoMicroSeconds), 20}
								  << QJsonValue{20};
	QTest::newRow("milliseconds") << QVariantHash{}
								  ...
								  << QCborValue{static_cast<QCborTag>(CborSerializer::ChronoMilliSeconds), 30}
								  << QJsonValue{30};
	QTest::newRow("seconds") << QVariantHash{}
							 ...
							 << QCborValue{static_cast<QCborTag>(CborSerializer::ChronoSeconds), 40}
							 << QJsonValue{40};
	QTest::newRow("minutes") << QVariantHash{}
							 ...
							 << QCborValue{static_cast<QCborTag>(CborSerializer::ChronoMinutes), 50}
							 << QJsonValue{50};
	QTest::newRow("hours") << QVariantHash{}
						   ...
						   << QCborValue{static_cast<QCborTag>(CborSerializer::ChronoHours), 60}
						   << QJsonValue{60};
}
...
void ChronoDurationConverterTest::addDeserData()
{
	...
	QTest::newRow("nanoseconds.milli") << QVariantHash{}
									   ...
									   << QCborValue{static_cast<QCborTag>(CborSerializer::ChronoMilliSeconds), 20}
									   << QJsonValue{QJsonValue::Undefined};
	QTest::newRow("nanoseconds.secs") << QVariantHash{}
									  ...
									  << QCborValue{static_cast<QCborTag>(CborSerializer::ChronoSeconds), 20}
									  << QJsonValue{QJsonValue::Undefined};
	QTest::newRow("nanoseconds.mins") << QVariantHash{}
									  ...
									  << QCborValue{static_cast<QCborTag>(CborSerializer::ChronoMinutes), 20}
									  << QJsonValue{QJsonValue::Undefined};
	QTest::newRow("nanoseconds.hours") << QVariantHash{}
									   ...
									   << QCborValue{static_cast<QCborTag>(CborSerializer::ChronoHours), 20}
									   << QJsonValue{QJsonValue::Undefined};
	...
	QTest::newRow("microseconds.nano") << QVariantHash{}
									   ...
									   << qMetaTypeId<microseconds>()
									   << QVariant{}
									   << QCborValue{static_cast<QCborTag>(CborSerializer::ChronoNanoSeconds), 20}
									   << QJsonValue{QJsonValue::Undefined};
