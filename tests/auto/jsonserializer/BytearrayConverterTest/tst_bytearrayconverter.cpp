...
{
	QTest::newRow("bytearray.bytearray") << static_cast<int>(QMetaType::QByteArray)
										 << true;
	QTest::newRow("bytearray.invalid.string") << static_cast<int>(QMetaType::QString)
											  << false;
	QTest::newRow("bytearray.invalid.char") << static_cast<int>(QMetaType::Char)
											<< false;
	QTest::newRow("bytearray.invalid.string") << static_cast<int>(QMetaType::Int)
											  << false;
}

void BytearrayConverterTest::addCommonSerData()
{
	QTest::newRow("bytearray.basic") << QVariantHash{}
									 << TestQ{}
...
void BytearrayConverterTest::addDeserData()
{
	...
	QTest::newRow("bytearray.invalid") << QVariantHash{{QStringLiteral("validateBase64"), false}}
									   << TestQ{}
									   << static_cast<QObject*>(nullptr)
									   << static_cast<int>(QMetaType::QByteArray)
									   << QVariant{QByteArrayLiteral("Hello World8")}
									   << QJsonValue{QStringLiteral("SGVsbG8#'gV29ybGQ=42")};
	QTest::newRow("bytearray.validated1") << QVariantHash{{QStringLiteral("validateBase64"), true}}
										  << TestQ{}
										  << static_cast<QObject*>(nullptr)
										  << static_cast<int>(QMetaType::QByteArray)
										  << QVariant{}
										  << QJsonValue{QStringLiteral("SGVsbG8#'gV29ybGQ=42")};
	QTest::newRow("bytearray.validated2") << QVariantHash{{QStringLiteral("validateBase64"), true}}
										  << TestQ{}
										  << static_cast<QObject*>(nullptr)
										  << static_cast<int>(QMetaType::QByteArray)
										  << QVariant{}
										  << QJsonValue{QStringLiteral("SGVsbG8gV29ybGQ2=")};
	QTest::newRow("bytearray.validated3") << QVariantHash{{QStringLiteral("validateBase64"), true}}
										  << TestQ{}
										  << static_cast<QObject*>(nullptr)
										  << static_cast<int>(QMetaType::QByteArray)
										  << QVariant{}
